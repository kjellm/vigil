...
describe Vigil do
  ...
  it do
    ...
    shell.should_receive('exists?').with("/Users/kjellm/projects/vigil/run/znork/boxes/znork-1.box").ordered.and_return(false)
    shell.should_receive('exists?').with("/Users/kjellm/projects/vigil/run/znork/boxes/znork-0.box").ordered.and_return(false)
    ...
    shell.should_receive('exists?').with("/Users/kjellm/projects/vigil/run/znork/boxes/znork-0_no_gems.pkg").ordered.and_return(false)
    ...
    shell.should_receive('exists?').with("/Users/kjellm/projects/vigil/run/znork/boxes/znork-0_complete.pkg").ordered.and_return(false)
